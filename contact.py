...
#Search Bar
search_label = tk.Label(window, text="Search:", font=font_label, foreground="white", bg="#101010")
search_label.place(x=50, y=320)
search_entry = tk.Entry(window, font=font_entry, width=30, bg="#404040", fg="white", insertbackground="white")
search_entry.place(x=200, y=320)

search_button = tk.Button(window, text="Search", font=font_button, relief="raised", borderwidth=4, width=14, bg="#505050", fg="white", activebackground="#104E8B", command=search_contacts)
